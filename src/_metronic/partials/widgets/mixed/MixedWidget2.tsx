...
const MixedWidget2: React.FC<Props> = ({className, chartColor, chartHeight, strokeColor,totalUsers,approveUser,unapproveUser,totalGame,Revenue}) => {
  ...
  return (
    ...
    >
      ...
      <h3 className="card-title align-items-start flex-column text-white pt-15">
        <span className="fw-bold fs-2x mb-3"> Welcome Back ! Admin</span>
          ...
          <div className="col-6">
            ...
            <div className="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
              ...
              <div className="m-0">
                ...
                <span className="text-gray-500 fw-semibold fs-6">Approved Users</span>
                  </div>
                ...
                <span className="text-gray-500 fw-semibold fs-6">Unapproved Users</span>
                  </div>
