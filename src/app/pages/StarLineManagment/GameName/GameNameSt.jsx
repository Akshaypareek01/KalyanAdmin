  ...
  try {
    ...
    console.log("POST request response:", data);
      if(data.game && data !== undefined){
         ...
         "Market_Status":item.market_status === "1" ? <Button size='small' onClick={()=>handelMarketStausChange(item.g_id,"0")} variant="contained" color='success' >Today Open</Button> : <Button size='small' variant="contained" onClick={()=>handelMarketStausChange(item.g_id,"1")} color='error' >Today Close</Button>,
...
const handelGameSubmit = async()=>{
  try {
    ...
    formData1.append("market_status","1")
    // setIsLoading(true);
    const response = await axios.post(
      
      `${Base_Url2}users/sservice_add`,
      formData1
    ,
      {
        headers: {
...
const GameUpdate=async(id)=>{
  try {
    ...
    formData1.append("market_status",EditGameData.market_status)
    // setIsLoading(true);
    const response = await axios.post(
      
      `${Base_Url2}users/gs_update/${id}`,
      formData1
    ,
      {
        headers: {
...
const handelStausChange=async(id,value)=>{
  ...
  try {
    ...
    const response = await axios.post(
      ...
      `${Base_Url2}users/gs_published/${id}`,
      formData1
    ,
      {
        headers: {
...
const handelMarketStausChange=async(id,value)=>{
  ...
  try {
    ...
    formData1.append("market_status",value)
   
    // setIsLoading(true);
    const response = await axios.post(
      
      `${Base_Url2}users/gs_market/${id}`,
      formData1
    ,
      {
        headers: {
