  ...
  return (
    <Box>
      <Card>
        <CardContent>
          <Box>
            <Typography variant='h3'>Half Sangam Digitss</Typography>
          </Box>
          <Box margin="20px">
            <Typography fontSize="16px" fontWeight="bold">Open / Close ank</Typography>
           </Box>
          <Box display="flex" flexWrap="wrap" marginTop="30px" justifyContent="left" alignItems="center">
            ...
            Digits.map((el,index)=>{
              if(el.ank !== ""){
                return (
                  ...
                  <Typography variant='h4' color="black">{el.ank}</Typography>
                 </Box>
                   )
              }
           ...
           <Box margin="20px">
            <Typography fontSize="16px" fontWeight="bold">Open / Close Panna</Typography>
           </Box>
           <Box display="flex" flexWrap="wrap" marginTop="30px" justifyContent="left" alignItems="center">
           {
            Digits.map((el,index)=>{
